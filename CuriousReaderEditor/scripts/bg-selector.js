H5PEditor.CuriousReader.BackgroundSelector = (function ($, EventDispatcher) {

  /**
   * Create a Background Selector.
   *
   * @class H5PEditor.CuriousReader.BackgroundSelector
  ...
  function BackgroundSelector($backgroundSlides, isSingleSlide) {
    ...
    var radioLabels = [
      H5PEditor.t('H5PEditor.CuriousReader', 'setImageBackground', {}),
      H5PEditor.t('H5PEditor.CuriousReader', 'setColorFillBackground', {})
    ];
     ...
     * @returns {H5PEditor.CuriousReader.BackgroundSelector}
     */
    self.addResetButton = function (text) {
      text = text || H5PEditor.t('H5PEditor.CuriousReader', 'resetToDefault');
